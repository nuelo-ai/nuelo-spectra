...
- [ ] **PULSE-01**: Designer can view a mockup of the Analysis Workspace entry page with navigation and branding (separate from Chat)
...
- [ ] **PULSE-08**: Designer can view credit balance indicator and pre-action cost estimate ("This will use ~5 credits")
