...
export function OverviewStatCards({
  ...
  const cards = [
    { icon: FolderOpen, value: filesCount, label: "Files" },
    { icon: Activity, value: signalCount, label: "Signals" },
    { icon: FileText, value: reportsCount, label: "Reports" },
    { icon: Zap, value: creditsUsed, label: "Credits Used" },
  ];
